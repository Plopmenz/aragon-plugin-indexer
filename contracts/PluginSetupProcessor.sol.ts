...
export const PluginSetupProcessorAddressPerChain = {
  [sepolia.id]: "0xC24188a73dc09aA7C721f96Ad8857B469C01dC9f",
} as { [chainId: number]: Address | undefined };

export const PluginSetupProcessorAbi = [
  {
    inputs: [{ internalType: "contract PluginRepoRegistry", name: "_repoRegistry", type: "address" }],
  ...
  {
    inputs: [
      { internalType: "bytes32", name: "currentAppliedSetupId", type: "bytes32" },
      { internalType: "bytes32", name: "appliedSetupId", type: "bytes32" },
    ],
  ...
  { inputs: [], name: "PluginAlreadyInstalled", type: "error" },
  {
    inputs: [{ internalType: "address", name: "plugin", type: "address" }],
  ...
  { inputs: [], name: "PluginRepoNonexistent", type: "error" },
  {
    inputs: [{ internalType: "bytes32", name: "preparedSetupId", type: "bytes32" }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "bytes32", name: "appliedSetupId", type: "bytes32" },
    ],
  ...
  },
  {
    inputs: [],
    name: "repoRegistry",
    outputs: [{ internalType: "contract PluginRepoRegistry", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  {
    inputs: [
      { internalType: "bytes32", name: "pluginInstallationId", type: "bytes32" },
      { internalType: "bytes32", name: "preparedSetupId", type: "bytes32" },
    ],
